...
int main()
{
	std::cout << "Slow Sequencial: ";
	Sequencial();

  std::fstream fs;
  fs.open ("bad_matrix_sequencial.csv", std::fstream::in | std::fstream::out | std::fstream::app);
